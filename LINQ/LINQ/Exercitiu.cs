...
namespace LINQ
{
    public class Exercitiu
    {
        ...
        {
            List<Singer> singers = (List<Singer>)GetSingers();
            List<Concert> concerts = (List<Concert>)GetConcerts();

            var result = from concert in concerts
                         join singer in singers on concert.SingerId equals singer.Id
                         where singer.FirstName == "Elvis" && singer.LastName == "Presley" && concert.Year > 1950 && concert.Year < 1980 && concert.Country == "Germany"
